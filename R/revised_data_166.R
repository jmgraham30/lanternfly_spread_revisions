...
corrected_166 <- read_xlsx("data/S1Datav2.xlsx",
                           sheet="166 Region model",
                           range="A1:L167") |>
  janitor::clean_names()

glimpse(corrected_166)
...
data_to_map_166_inf <- corrected_166 |>
...
data_to_map_166_inf <- data_to_map_166_inf |>
  right_join(data_for_infested,by="fips")
...
write_csv(data_to_map_166_inf,"data/data_to_map_166_inf.csv")
